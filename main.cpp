...
{
    long long summ = 0;                         //îáùàÿ ñóììà
    long long total_size = right - left + 1;  //êîëè÷åñòâî ýëåìåíòîâ â çàäàííîì ó÷àñòêå ìàññèâà
    long long part_size = total_size / threads_num;    //ðàçìåð îäíîé ÷àñòè
    long long last_part_size = total_size % threads_num;    //ðàçìåð ïîñëåäíåé ÷àñòè, åñëè íå äåëèòñÿ íàöåëî
    ...
    for (int i = 0; i < threads_num; ++i)
    {
        ...
        //threads[i].join();    //åñëè äæîéíèòü çäåñü, òî ìíîãîïîòî÷íîñòè íå áóäåò, ïîòîêè áóäóò âûïîëíÿòüñÿ äðóã çà äðóãîì
    }

    //*
    for (int i = 0; i < threads_num; ++i)
    {
        threads[i].join();      //à åñëè çäåñü, òî ïîòîêè áóäóò âûïîëíÿòüñÿ àñèíõðîííî
    }
    //*/
